...
class PurchasedNumber(Model):
    ...
    user = fields.ForeignKeyField("models.User", related_name="purchased_number", on_delete=fields.CASCADE)
    phone_number = fields.CharField(max_length=20)
    company = fields.ForeignKeyField("models.Company", related_name="purchased_numbers", on_delete=fields.CASCADE)
